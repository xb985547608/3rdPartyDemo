...
Controls.Calendar {
    ...
    style: CalendarStyle {
        ...
        navigationBar: Rectangle {
			...
			ColumnLayout {
				...
				Label {
                    ...
                    text: control.selectedDate.toLocaleString(control.__locale, isLandscape ? "ddd\nMMM dd" : "ddd, MMM dd")
				}
			}
        }
        ...
        dayOfWeekDelegate: Rectangle {
            ...
            Label {
                text: control.__locale.dayName(styleData.dayOfWeek, Locale.NarrowFormat).substring(1)
...
//                            }
                        ...
                        RectangleSmear {
                            id: smear
                            originalWidth: __cellRectAt(view.currentIndex).width
                            originalHeight: __cellRectAt(view.currentIndex).height
                            radius: Math.min(originalWidth, originalHeight)/2
                            isSquare: true
                        }
                        ...
                        Repeater {
                            ...
                            function triggerAnitation() {
                                smear.move(Qt.point(__cellRectAt(currentIndex).x,
                                                    __cellRectAt(currentIndex).y))
                            }

                            onCurrentIndexChanged: triggerAnitation()
                            ...
                            delegate: Loader {
                                ...
                                property QtObject styleData: QtObject {
                                    ...
                                    readonly property bool selected: control.selectedDate.getDate() === date.getDate()
    ...
    Component.onCompleted: selectedDate = new Date()
}
