    ...
    indicator: Item {
        ...
        Rectangle {
            ...
            border.color: control.enabled
                    ? control.checked || control.checkedState === Qt.PartiallyChecked
                                      ? style.color
            ...
            color: control.checked || control.checkedState === Qt.PartiallyChecked
                        ? __internalColor : "transparent"
